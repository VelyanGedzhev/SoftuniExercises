    ...
    public class Deserializer
    {
        ...
        public static string ImportPrisonersMails(SoftJailDbContext context, string jsonString)
        {
            ...
            foreach (var currentPrisoner in prisonerMails)
            {
                ...
                var isValidReleasedDate = DateTime.TryParseExact(currentPrisoner.ReleaseDate, "dd/MM/yyyy", CultureInfo.InvariantCulture,
                    DateTimeStyles.None,
                ...
                var prisoner = new Prisoner
                {
                    ...
                    ReleaseDate = isValidReleasedDate ? (DateTime?)releaseDate : null,
        ...
        public static string ImportOfficersPrisoners(SoftJailDbContext context, string xmlString)
        {
            ...
            foreach (var officerPrisoner in officerPrisoners)
            {
                ...
                var officer = new Officer
                {
                    ...
                    OfficerPrisoners = officerPrisoner.Prisoners
