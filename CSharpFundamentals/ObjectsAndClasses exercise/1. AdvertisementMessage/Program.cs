...
namespace _1._AdvertisementMessage
{
    ...
    public class AdvertisementMessage
    {
        public static string[] Phrases = new string[]
        {
            ...
            "Best product of its category.", "Exceptional product.", "I can’t live without " +
            "this product."
        };

        public static string[] Events = new string[] { "Now I feel good.", "I have succeeded " +
            "with this product.", "Makes miracles. I am happy of the results!",
        ...
        public static string GenerateMessage()
        {
            ...
            return $"{phrase} {currentEvent} {author} {city}";
        }
    }
}
