    ...
    function addFurniture(e) {
        ...
        if (modelField.value != '' &&
            ...
            priceValue > 0) {
                ...
                hideTr.innerHTML = `<td>Year: ${yearField.value}</td><td colspan="3">Description: ${descriptionField.value}</td>`;
                ...
                moreInfoBtns[0].addEventListener('click', showMoreInfo);
                moreInfoBtns[1].addEventListener('click', buyFurniture);
        }
